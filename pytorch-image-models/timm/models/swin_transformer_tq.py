...
class TQ_SwinTransformerBlock_TQ_ATTN(nn.Module):
    """ Swin Transformer Block.
    """
...
class TQ_SwinTransformerBlock_TQ_FFN(nn.Module):
    """ Swin Transformer Block.
    """
...
class TQ_SwinTransformerStage(nn.Module):
    ...
    def __init__(
        ...
        for i in range(depth):
            if i%2==1:   # i%2==1 better
                blocks.append(TQ_SwinTransformerBlock_TQ_ATTN(
                dim=out_dim,
                ...
                blocks.append(TQ_SwinTransformerBlock_TQ_FFN(
                dim=out_dim,
                input_resolution=self.output_resolution,
                num_heads=num_heads,
                head_dim=head_dim,
...
class TQ_SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        print('swin embed_dim per stage:', embed_dim)
        ...
        for i in range(self.num_layers):
            out_dim = embed_dim[i]
            layers += [TQ_SwinTransformerStage(
                dim=in_dim,
                out_dim=out_dim,
                input_resolution=(
...
def _create_tq_swin_transformer(variant, pretrained=False, **kwargs):
...
default_cfgs = generate_default_cfgs({
    'tq_swin_small_patch4_window7_224.ms_in22k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.8/tq_swin_small_patch4_window7_224_22kto1k_finetune.pth', ),
    'tq_swin_base_patch4_window7_224.ms_in22k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_base_patch4_window7_224_22kto1k.pth',),
    'tq_swin_base_patch4_window12_384.ms_in22k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_base_patch4_window12_384_22kto1k.pth',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0),
    'tq_swin_large_patch4_window7_224.ms_in22k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_large_patch4_window7_224_22kto1k.pth',),
    'tq_swin_large_patch4_window12_384.ms_in22k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_large_patch4_window12_384_22kto1k.pth',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0),

    'tq_swin_tiny_patch4_window7_224.ms_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_tiny_patch4_window7_224.pth',),
    'tq_swin_small_patch4_window7_224.ms_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_small_patch4_window7_224.pth',),
    'tq_swin_base_patch4_window7_224.ms_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_base_patch4_window7_224.pth',),
    'tq_swin_base_patch4_window12_384.ms_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_base_patch4_window12_384.pth',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0),

    # tiny 22k pretrain is worse than 1k, so moved after (untagged priority is based on order)
    'tq_swin_tiny_patch4_window7_224.ms_in22k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.8/tq_swin_tiny_patch4_window7_224_22kto1k_finetune.pth',),

    'tq_swin_tiny_patch4_window7_224.ms_in22k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.8/tq_swin_tiny_patch4_window7_224_22k.pth',
        num_classes=21841),
    'tq_swin_small_patch4_window7_224.ms_in22k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.8/tq_swin_small_patch4_window7_224_22k.pth',
        num_classes=21841),
    'tq_swin_base_patch4_window7_224.ms_in22k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_base_patch4_window7_224_22k.pth',
        num_classes=21841),
    'tq_swin_base_patch4_window12_384.ms_in22k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_base_patch4_window12_384_22k.pth',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, num_classes=21841),
    'tq_swin_large_patch4_window7_224.ms_in22k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_large_patch4_window7_224_22k.pth',
        num_classes=21841),
    'tq_swin_large_patch4_window12_384.ms_in22k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/TQ_SwinTransformer/storage/releases/download/v1.0.0/tq_swin_large_patch4_window12_384_22k.pth',
        input_size=(3, 384, 384), pool_size=(12, 12), crop_pct=1.0, num_classes=21841),

    'tq_swin_s3_tiny_224.ms_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/s3_t-1d53f6a8.pth'),
    'tq_swin_s3_small_224.ms_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/s3_s-3bb4c69d.pth'),
    'tq_swin_s3_base_224.ms_in1k': _cfg(
        hf_hub_id='timm/',
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/s3_b-a1e95db4.pth'),

    #tq swin
    'tq_swin_tiny_patch4_window7_224': _cfg(crop_pct=0.875),
})


@register_model
def tq_swin_tiny_patch4_window7_224(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    """ Swin-T @ 224x224, trained ImageNet-1k
    """
    model_args = dict(patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24))
    return _create_tq_swin_transformer(
        'tq_swin_tiny_patch4_window7_224', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def tq_swin_small_patch4_window7_224(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    """ Swin-S @ 224x224
    """
    model_args = dict(patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24))
    return _create_tq_swin_transformer(
        'tq_swin_small_patch4_window7_224', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def tq_swin_base_patch4_window7_224(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    """ Swin-B @ 224x224
    """
    model_args = dict(patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32))
    return _create_tq_swin_transformer(
        'tq_swin_base_patch4_window7_224', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def tq_swin_base_patch4_window12_384(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    """ Swin-B @ 384x384
    """
    model_args = dict(patch_size=4, window_size=12, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32))
    return _create_tq_swin_transformer(
        'tq_swin_base_patch4_window12_384', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def tq_swin_large_patch4_window7_224(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    """ Swin-L @ 224x224
    """
    model_args = dict(patch_size=4, window_size=7, embed_dim=192, depths=(2, 2, 18, 2), num_heads=(6, 12, 24, 48))
    return _create_tq_swin_transformer(
        'tq_swin_large_patch4_window7_224', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def tq_swin_large_patch4_window12_384(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    """ Swin-L @ 384x384
    """
    model_args = dict(patch_size=4, window_size=12, embed_dim=192, depths=(2, 2, 18, 2), num_heads=(6, 12, 24, 48))
    return _create_tq_swin_transformer(
        'tq_swin_large_patch4_window12_384', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def tq_swin_s3_tiny_224(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    ...
    return _create_tq_swin_transformer('tq_swin_s3_tiny_224', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def tq_swin_s3_small_224(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    ...
    return _create_tq_swin_transformer('tq_swin_s3_small_224', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def tq_swin_s3_base_224(pretrained=False, **kwargs) -> TQ_SwinTransformer:
    ...
    return _create_tq_swin_transformer('tq_swin_s3_base_224', pretrained=pretrained, **dict(model_args, **kwargs))


# register_model_deprecations(__name__, {
#     'tq_swin_base_patch4_window7_224_in22k': 'tq_swin_base_patch4_window7_224.ms_in22k',
#     'tq_swin_base_patch4_window12_384_in22k': 'tq_swin_base_patch4_window12_384.ms_in22k',
#     'tq_swin_large_patch4_window7_224_in22k': 'tq_swin_large_patch4_window7_224.ms_in22k',
#     'tq_swin_large_patch4_window12_384_in22k': 'tq_swin_large_patch4_window12_384.ms_in22k',
# })
